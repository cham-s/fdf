...
/*   Updated: 2016/03/22 03:47:41 by apellicc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	env(t_env *env)
{
	...
	e->img_iso->data = mlx_get_data_addr(e->img_iso->img, &e->img_iso->bbp,
		   	&e->img_iso->size_line, &e->img_iso->endian);
	e->img_para->data = mlx_get_data_addr(e->img_para->img, &e->img_para->bbp,
